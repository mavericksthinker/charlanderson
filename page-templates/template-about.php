        ...
        <section class="about__hero-section hero">
            <div class="about-page__hero-section__image">
                <div class="hero-header">
                    <h1 class="coach-page-header__text animate fadeInUp">Meet Charla</h1>
                </div>
            </div>
            ...
            <div class="about-body">
                <div class="about-section-body">
                    ...
                    <p class="about-paragraph-right animate slide-right" >
                        Joy is my lifestyle, wellness is my passion, encouragement is my gift…to you! My purpose is to share
                        the message of unconditional Love that inspires direction, motivates action, and moves you toward
                        joy, peace, and abundance.
                        Leave your Legacy of Intentional Significance - As a Ziglar Legacy Certified Trainer, serial
                        entrepreneur, author, coach, wellness advocate, world traveler, City of Fort Worth ambassador,
                        veteran flight-attendant of 34 years, and mother of three grown children, I have an abundance of
                        life experiences to share & inspire your journey.
                        My mission is to Love people through these unsteady times, to live in complete Peace, nurturing
                        presence in every moment and make a difference in your life. I am here to encourage you. I am here
                        to remind you of WHO YOU ARE, which is perfect, exactly as you are!
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="about-body">
                ...
                <div class="about-section-body">
                    <p class="about-paragraph-left animate slide-left" style="color: white">
                        I spent 34 incredible years as a flight-attendant for Delta AirLines, raised a family of 3 kids plus 3
                        step-children, and owned my own businesses. We were the neighborhood hangout (we had a pool
                        in Texas), the kids & I went on numerous mission trips, and traveled the country (including two
                        family trips to Space Camp); there was never a dull moment, and I was always busy.
                        In addition, I became a charter member of Zurvita in 2008 where I began networking, meeting
                        people, truly living by this motto of: "When intriguing opportunities present themselves, & you say
                        YES, things show up!"
                        By saying “yes,” I created my own radio shows, TV shows, traveled, hosted events, & everything in
                        between. Getting my Ziglar Legacy Certification was a huge blessing, & I began Speaking &
                        Coaching. I self-published my first book, “Candy Bar Hugs” with two more books in the works, and
                        started a pay-it-forward movement.
                        My mission is to "Leave the world a better place" by Loving each person I encounter,
                        unconditionally, & letting my light shine. I am Outrageously Optimistic & Outrageously Courageous.
                        I Choose JOY! I Choose Love! And I choose to bless You, and see you Smile.
                    </p>
                    <figure>
