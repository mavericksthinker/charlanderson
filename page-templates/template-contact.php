    ...
    <main class="main-body">
        <section class="about__hero-section hero">
            <div class="choices__hero-section__image">
                <h1 class="header-text animate fadeInUp">Connect with Charla</h1>
            </div>
                ...
                <div class="contact-section__body">
                    ...
                    <div class="contact-page__content">
                        <div class="contact-form__container contact-form__container-contact-page">
                            <div role="form" class="wpcf7" style="margin: 0!important;width: 100%" id="wpcf7-f5-o1" lang="en-US" dir="ltr">
                                <div class="screen-reader-response" role="alert" aria-live="polite"></div>
                                <form action="/contact-charla/#wpcf7-f5-o1" method="post" class="wpcf7-form init" novalidate="novalidate">
