...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-180794612-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-180794612-1');
    </script>
</head>
...
<!--                        </figure>-->
                        <div class="contact-form__content">
                            ...
                            <div class="contact-form__container">
                                <div role="form" class="wpcf7" style="margin: 0!important;" id="wpcf7-f38-o1" lang="en-US" dir="ltr">
                                    <div class="screen-reader-response" role="alert" aria-live="polite"></div>
                                    <form action="<?php echo $_SERVER['REQUEST_URI'].'#wpcf7-f38-o1'?>" method="post" class="wpcf7-form init" novalidate="novalidate">
                                        ...
                                        <input type="hidden"
                                               ...
                                               value="<?php echo get_template_directory_uri(); ?>/src/assets/charlas_declaration.pdf"
                                               size="40"
